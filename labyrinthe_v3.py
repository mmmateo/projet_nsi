    ...
    def update(self):
        ...
        if pyxel.btn(122):
            ...
            if self.facing<=90 or self.facing>270:
                if pyxel.pget(self.x//90+int(pyxel.cos(self.facing)*45)//90+1,self.y//90)!=0:
                    self.x+=int(pyxel.cos(self.facing)*45)
                elif self.x+int(pyxel.cos(self.facing)*45)<(self.x//90)*90+90:
                    self.x+=int(pyxel.cos(self.facing)*45)
                else:
                    self.x=(self.x//90)*90+89
            else:
                if pyxel.pget(self.x//90+int(pyxel.cos(self.facing)*45)//90,self.y//90)!=0:
                    self.x+=int(pyxel.cos(self.facing)*45)
                elif self.x+int(pyxel.cos(self.facing)*45)>(self.x//90)*90:
                    self.x+=int(pyxel.cos(self.facing)*45)
                else:
                    self.x=(self.x//90)*90
                    
            if self.facing>180:
                if pyxel.pget(a//90,self.y//90+int(pyxel.sin(self.facing)*45)//90)!=0:
                    self.y+=int(pyxel.sin(self.facing)*45)
                elif self.y+int(pyxel.sin(self.facing)*45)>(self.y//90)*90:
                    self.y+=int(pyxel.sin(self.facing)*45)
                else:
                    self.y=(self.y//90)*90
            else:
                if pyxel.pget(a//90,self.y//90+int(pyxel.sin(self.facing)*45)//90+1)!=0:
                    self.y+=int(pyxel.sin(self.facing)*45)
                elif self.y+int(pyxel.sin(self.facing)*45)<(self.y//90)*90+90:
                    self.y+=int(pyxel.sin(self.facing)*45)
                else:
