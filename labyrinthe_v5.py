...
class Labyrinthe:
    def __init__(self, p, q):
        ...
        self.pyxels=[[1 for i in range(q*10)]for j in range(p*10)]
        self.creer()
...
class Personnage:
 ...
 #le tableau 2d représentant les pyxels est créé mais je sais pas si il faut regler les collisions ou le tableau       
